...
result_df['Calculation'] = (result_df['Right Value'] - result_df['Left Value']) / (
            result_df['Right Value'] + result_df['Left Value'])
...
result_df.to_csv('result.csv', index=False)  # You can replace the result.csv with the output path variable
